...
public class BookServices {
    ...
    public ServiceResult addBook(Book book) { // where we using this ? in class BookController when we want to add a
                                              // book from the book management panel
        if (book == null) {
    ...
    public ServiceResult searchBookByIsbn(String isbn) { // where we using this ? in class BookController when we want
                                                         // to search for a book by isbn from the book management panel
    ...
    public ServiceResult searchBookByTitle(String title) { // where we using this ? in class BookController when we want
                                                           // to search for a book by title from the book management
                                                           // panel
    ...
    public ServiceResult deleteBook(String isbn) { // where we using this ? in class BookController when we want to
                                                   // delete a book from the book management panel
        Book book = avlBooks.search(isbn);
        if (book == null) {
            return new ServiceResult(false, "Book not found");
        }
    ...
    public ServiceResult addCopies(String isbn, int count) { // where we using this ? in class BookController when we
                                                             // want to add copies to a book in the book management
                                                             // panel
        if (count <= 0) {
    ...
    public ServiceResult reduceCopies(String isbn, int count) { // where we using this ? in class BookController when we
                                                                // want to reduce the number of copies of a book in the
    ...
    public ServiceResult getAllBooks() { // where we using this ? in class BookController when we want to show all books
                                         // in the table in the book management panel
    ...
    public Book getBookByIsbn(String isbn) { // where we using this ? in class BorrowServices when we want to get the
                                             // book object by isbn to check if the user can borrow it or not // حكي
                                             // ذكاء اصطناعي
    ...
    public void saveBooks() { // we using this in class BorrowedServices when we want to save the books to the
                              // disk after we borrowed or returned a book we handling this with txtDataStore
        TxtDataStore.saveBooks(getAllBookObjects());
    }
